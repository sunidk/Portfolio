...
function experience()
{
    ...
    <div>
      ...
      <ul>
        ...
        <li>Handling Theory Classes and Practical training Classes.</li>
        <li>Conducting Monthly tests and Supervising the abilities of Students.</li>
...
function skill()
{
    ...
    <div class="tech">
     ...
     <div><li><img src="/Images/react.png" alt="">REACT.JS : Knowledge on basic React concepts.</li></div>
     <div><li><img src="/Images/sql.png" alt="">SQL : Knowledge on writing Queries and Sub-Queries.</li></div>
    ...
    <div class="soft">
     ...
     <ul>
       ...
       <li>Able to work quickly under pressure.</li>
...
function interest()
{
  ...
  <div id="design">
    ...
    <img src="/Images/Starbucks.jpg" alt="">  </div>
</div>`
